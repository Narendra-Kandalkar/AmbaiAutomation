...
<section id="faq" className="faq section-bg">
  <div className="container" data-aos="fade-up">
    <div className="section-title">
      ...
      <p className='text-start'>Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit sint consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias ea. Quia fugiat sit in iste officiis commodi quidem hic quas.</p>
    </div>
    <div className="faq-list text-start">
      <ul>
        ...
        <li data-aos="fade-up" data-aos-delay={500}>
          <i className="bx bx-help-circle icon-help d-flex text-start" /> <a data-bs-toggle="collapse" data-bs-target="#faq-list-5" className="collapsed text-start">Tortor vitae purus faucibus ornare. Varius vel pharetra vel turpis nunc eget lorem dolor? <i className="bx bx-chevron-down icon-show" /><i className="bx bx-chevron-up icon-close" /></a>
